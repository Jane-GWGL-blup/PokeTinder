...
import com.caceres.poketinder.data.Onboarding
import com.caceres.poketinder.databinding.ItemOnboardingBinding
...
class OnboardingAdapter(val list: List<Onboarding>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnboardingAdapter.OnboardingHolder {
        val view = parent.inflate(R.layout.item_onboarding)
        return OnboardingHolder(view)
    }

    override fun onBindViewHolder(holder: OnboardingAdapter.OnboardingHolder, position: Int) {
